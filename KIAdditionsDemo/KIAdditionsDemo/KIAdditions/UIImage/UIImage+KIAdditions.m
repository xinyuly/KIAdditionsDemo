...
- (UIImage *)addMsakImage:(UIImage *)maskImage {
    ...
    int logoWidth = maskImage.size.width;
    int logoHeight = maskImage.size.height;
    UIGraphicsBeginImageContext(self.size);
    [self drawInRect:CGRectMake(0, 0, self.size.width, self.size.height)];
    
    [maskImage drawInRect:CGRectMake(w-logoWidth*4, h-logoHeight*4 , logoWidth*4, logoHeight*4)];
